...
<div class="content content-boxed">
   <div class="block block-rounded">
	 ...
	 <div class=" p-4 rounded-3 shadow-sm">
            <h1 class="fw-bold text-primary-dark mb-4">Study Nexus - Terms of Service</h1>

            <section class="mb-4">
                <p>This document constitutes the Terms of Service Agreement (the "Agreement"), outlining the terms and conditions for using Study Nexus ("Study Nexus", "we", "us" or "our"). By accessing or using Study Nexus, you agree to these terms.</p>
            </section>

            <section class="mb-4">
                <h2 class="h3 text-primary-dark border-bottom pb-2 mb-3">1. Acceptance of Terms</h2>
                <p>By accessing or using Study Nexus, you acknowledge that you have read, understood, and agree to be bound by this Agreement. If you do not agree with any part of these terms, you must not use Study Nexus. Your continued use of the site constitutes acceptance of any updates or modifications.</p>
            </section>

            <section class="mb-4">
                <h2 class="h3 text-primary-dark border-bottom pb-2 mb-3">2. Modifications</h2>
                <p>Study Nexus reserves the right to amend or modify this Agreement at any time. We will notify you of significant changes through our website or via email. It is your responsibility to review the Agreement periodically. Continued use of Study Nexus after any changes constitutes acceptance of the modified terms.</p>
            </section>

            <section class="mb-4">
                <h2 class="h3 text-primary-dark border-bottom pb-2 mb-3">3. Purpose and Limitation of Liability</h2>
                <p>Study Nexus provides general information about educational institutions and programs for personal, non-commercial use only. While we strive to ensure accuracy, we do not guarantee the completeness or reliability of any information. You are responsible for verifying the information and conducting your own research. Study Nexus is not liable for any damages or losses resulting from reliance on the information provided.</p>
            </section>
            ...
            <section class="mb-4">
                ...
                <ul>
                    ...
                    <li>Attempt to damage, disable, or impair Study Nexus.</li>

...
<div class="content">
    <div class="block block-rounded">
        ...
        <div class="block-content">
            ...
            <h2 class="content-heading text-center">Accredited {{str::title($level->name)}} Courses Offered in Nigeria </h2>
            <div class="row items-push">
                ...
                <div class="block-header block-header-default fs-5" role="tab" id="programs_h{{$loop->iteration}}">
                  <div>{{str::title($collegeName)}} <span class="text-black fs-6 fw-normal">({{count($programs)}}) </span></div>   <span class="toggle-icon fw-light fs-2"> </span>
                </div>
                 </a>
                            <div id="programs_q{{$loop->iteration}}" class="collapse" role="tabpanel" aria-labelledby="programs_h{{$loop->iteration}}" data-bs-parent="#programs">
                                <div class="block-content">
                                    ...
                                    <div class="block block-rounded mb-1">
                                        <a class="fw-normal " href="{{route('programs.show', ['level' => $level->slug, 'program' => $program->id])}}" ">

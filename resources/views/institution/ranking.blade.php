...
<div class="bg-image" style="background-image: url('{{asset('/media/photos/photo13@2x.jpg')}}');">
    <div class="bg-black-75">
        <div class="content content-full content-top text-center pt-7">
            <div class="pt-4 pb-3">
                <h1><a class="fw-light text-white mb-1" href="{{route('institutions.categories.ranking', ['category' => $category->slug])}}">{{str::title($category->name)}} Rankings</a></h1>
                    ...
                    <table class="table table-bordered table-striped table-vcenter ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="fs-sm">
                                    <a href="{{route('institutions.show', ['institution' => $institution->id])}}">{{str::of($institution->name)->title()}}</a>
                                </td>

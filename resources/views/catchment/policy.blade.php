		     ...
		     <!-- Social Actions -->
				...
				<div class="btn-group me-1" role="group">
					<button type="button" class="btn btn-sm btn-alt-primary dropdown-toggle" id="dropdown-blog-news" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<i class="fa fa-share-alt opacity-50 me-1"></i> Share Catchment Policy
					</button>
...
<div class="content content-boxed">
	...
	<div class=" p-4 rounded-3 shadow-sm">
            <h1 class="fw-bold text-primary-darker mb-4">Catchment Area Policy for Nigerian Higher Education Institutions</h1>

            <section class="mb-4">
                <h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">Introduction</h2>
            ...
            <section class="mb-4">
                <h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">What is a Catchment Area?</h2>
            ...
            <section class="mb-4">
                <h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">Purpose of the Catchment Area Policy</h2>
                    <ul>
            ...
            <section class="mb-4">
                <h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">How the Catchment Area Policy Affects Admissions</h2>
            ...
            <section class="mb-4">
                <h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">Catchment Areas for Federal Universities</h2>
                    ...
                    <ul class="fs-sm">
                        <li><strong class="">University of Lagos (UNILAG):</strong> Lagos, Ekiti, Osun, Oyo, Ondo, Ogun.</li>
                        <li><strong class="">Abubakar Tafawa Balewa University (ATBU):</strong> Bauchi, Adamawa, Bauchi, Benue, Borno, Gombe, Taraba, Yobe.</li>
                         </ul>
            ...
            <section class="mb-4">
                <h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">Catchment Areas for State Universities</h2>
			...
			<section class="mb-4">
				<h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">Catchment Areas for Private Universities</h2>
			...
			<section class="mb-4">
				<h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">Catchment Areas for Polytechnics and Colleges of Education</h2>
				...
				<p><strong class="text-primary-darker">What You Need to Know:</strong></p>
				<ul>
					<li><strong class="text-primary-darker">General Principle:</strong> Most polytechnics and colleges of education give admission priority to students from states within their geographical region.</li>
					<li><strong class="text-primary-darker">No Formal List:</strong> Unlike federal universities, there's no formal, widely available list of catchment areas for polytechnics and colleges of education.</li>
					<li><strong class="text-primary-darker">Check with Institutions:</strong> Prospective students are advised to check directly with their chosen institution for specific catchment area details.</li>
				</ul>
			</section>

            <section class="mb-4">
                <h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">Admission Categories</h2>
                    <p>The catchment area policy works in tandem with the following admission categories:</p>
                    <ul>
                        <li><strong class="text-primary-darker">Merit:</strong> A percentage of admissions is based purely on merit, without consideration of the candidate's state of origin.</li>
                        <li><strong class="text-primary-darker">Catchment Area:</strong> A significant percentage of admissions is reserved for candidates from the catchment area.</li>
                        <li><strong class="text-primary-darker">Educationally Less Developed States (ELDS):</strong> Some slots are reserved for candidates from states identified as educationally less developed, to promote equal educational opportunities.</li>
                    </ul>
            </section>
			
			<section class="mb-4">
                    <h2 class="h3 text-primary-darker border-bottom pb-2 mb-3">How to Determine Your Catchment Area</h2>

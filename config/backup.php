...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' =>  'studynexus-backup',     // env('APP_NAME', 'laravel-backup'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'bridgeyuwa@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'bridgeyuwa@gmail.com'),
                'name' => env('MAIL_FROM_NAME', 'StudyNexus Backup'),
            ],
        ],
